...
@section('content')
    ...
    <div class="flex justify-center mb-4">
        <a href="{{ route('videos.manage.create') }}">
            <x-button color="gray" size="md">Afegir Vídeo</x-button>
        </a>
    </div>
    ...
    <div class="hidden sm:block overflow-x-auto">
        <table class="min-w-full bg-white rounded-lg shadow-lg divide-y divide-gray-200">
            ...
            <tr>
                ...
                <th class="px-6 py-3 text-left text-white font-semibold">Títol</th>
            ...
            @empty
                <tr>
                    <td colspan="3" class="px-6 py-4 text-center text-gray-500">No hi ha vídeos creats encara.</td>
                </tr>
            @endforelse
            </tbody>
        </table>
    ...
    <div class="sm:hidden px-4">
        <div class="space-y-4">
                ...
                <div class="bg-white p-4 rounded-lg border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
                    <div class="flex justify-between items-start">
                        ...
                        <div class="flex space-x-2">
                            <a href="{{ route('videos.manage.edit', $video->id) }}" class="text-blue-600 hover:text-blue-900">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z"/>
                                </svg>
                            </a>
                            <a href="{{ route('videos.manage.delete', $video->id) }}" class="text-red-600 hover:text-red-900">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            @empty
                <p class="text-center text-gray-500 py-4">No hi ha vídeos creats encara.</p>
            @endforelse
        </div>
    </div>
@endsection
