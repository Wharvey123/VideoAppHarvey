        ...
        <div class="max-w-xl mx-auto bg-gray-800 p-6 rounded-lg shadow-lg">
            ...
            <form action="{{ route('series.manage.store') }}" method="POST">
                ...
                <div class="flex justify-between mt-4">
                    <a href="{{ $redirect }}" class="bg-gray-500 text-white px-4 py-2 rounded hover:bg-gray-700">Tornar Enrere</a>
                    <button type="submit"><x-button color="blue">Desar Sèrie</x-button></button>
                </div>
            </form>
        </div>
    </div>
